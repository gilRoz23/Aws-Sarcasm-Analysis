...
public class AWS {
    ...
    public String bucket_name = "giladhayonyuvi";
    ...
    public boolean checkForInstanceTag(String tag){
    ...
    public void sendMessageToQueue(String queueName, String messageBody) {
        try{
            ...
            SendMessageResponse sendMessageResponse = sqs.sendMessage(SendMessageRequest.builder()
                    ...
                    .messageGroupId(""+System.currentTimeMillis()) // fifo queue need a message group id , i put the time stamp
                    .build());
